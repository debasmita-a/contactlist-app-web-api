...
public class FrameworkConstants {
    ...
    public static final String CONTACTS_PAGE_TEXT = "Click on any contact to view the Contact Details";
    public static final String FOOTER_TEXT = "Created by Kristin Jackvony, Copyright 2021 ";
